             ...
             try{
              ...
              var sectionid=$("#inputSection").val();
               var termid=$("#select_term").val();
                var sectionid=$("#inputSection").val();
        get_data(classid,termid,sectionid,subjectid);
            }
            catch(ex){}
        })
      ...
      function responseFail(response){
        return (response.data);
            ...
            var
              ...
              function get_data(classid,termid,sectionid,subjectid)
               {
                var userdata = [
                ...
                data_array = []
                  $.ajax({
                    ...
                    data: {classid:classid,subjectid:subjectid,sectionid:sectionid,recordstatus:change,termid:termid},
            ...
            $(document).on('click','#saveupdate',function(){
              ...
              var jsonString = JSON.stringify(data_array);
                    $.ajax({
                     url:'SaveResult',
                      type: 'POST',
                      data: {data:jsonString,candelete:true,termid:termid,classid:classid,sectionid:sectionid,subjectid:subjectid},
                      success: function(res){
                     alert("success");
             ...
             var sectionid=$("#inputSection ").val();
              ...
              $.ajax({
                     url:'exportResultdata',
                      type: 'POST',
                      data: {classid:classid,sectionid:sectionid,subjectid:subjectid,termid:termid},
                      success: function(data){
...
//               var subjectid=$("#select_subject").val();
//         get_data(classid,subjectid,2,3);
