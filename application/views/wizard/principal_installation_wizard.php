...
<script type="text/javascript">
    ...
    app.controller('installation_wizard', function($scope, $http, $filter,$q,$timeout){
        ...
        $scope.finishedWizard = function()
        {
            try{
                ...
                var formdata = new FormData();
                 ...
                 formdata.append('session_end',$scope.installation_obj.session_start);
                ...
                $scope.usersavebtntext = 'Saving';
                 var request = {
                    method: 'POST',
                    url: 'save_principal_wizard_settings',
        ...
        {
            httprequest('default_classes',({})).then(function(response){
        ...
        function loadSections()
        {
            try{
                ...
                httprequest('default_sections',{}).then(function(response){
        ...
        {
            try{
                httprequest('default_kindergarten_subject',{}).then(function(response){
                    if(response.length > 0 && response != null)
                    {
        ...
        function loadSubjects()
        {
            try{
                ...
                httprequest('default_subjects',{}).then(function(response){
                    if(response.length > 0 && response != null)
                    {
