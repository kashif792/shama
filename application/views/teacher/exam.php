	                					...
	                					<?php 
	                						...
	                						if(count($classlist))
	                						{
	                							...
	                							foreach ($classlist as $key => $value) {
	                								?>
	                									 <option  value="<?php echo $value->classid; ?>" <?php if(isset($schedule_single) && ($schedule_single[0]->classid == $value->classid)){echo 'selected';}?> required="required"><?php echo $value->grade; ?></option>
	                								<?php
	                							}
	                						}
	                					?>
