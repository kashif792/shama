<div class="col-lg-4 widget hide"  ng-controller="attendanceChartController" ng-init="getBaseUrl('<?php echo base_url(); ?>')">
    <div class="widget-header" id="widget-header" ng-init="getAttendanceCount()">
        <div class="option-row">
            <ul class="widget-menu">
                <li>
                  <div class="dropdown">
                      <button class="btn btn-default dropdown-toggle" data-view="all" id="tt" class="dropdown-toggle menu-option-click" data-toggle="dropdown">
                        <span id="option-text">{{chartType}}</span>
                        <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu pull-right" ng-model="selectedopt">
                          <li>
                              <a id="widget3ChartOptions" ng-click="chartTypeSelector(0)" href="#">Pie chart</a>
                          </li>
                          <li>
                              <a id="widget3ChartOptions" ng-click="chartTypeSelector(1)" href="#">Bar chart</a>
                          </li>
                      </ul>
                    </div> 
                </li>
                <li>
                  <div class="dropdown">
                      <button class="btn btn-default  dropdown-toggle" data-view="all" id="tt" class="dropdown-toggle menu-option-click" data-toggle="dropdown">
                        <span id="option-text">{{chartPeriod}}</span>
                        <span class="caret"></span>
                      </button>
                      <ul class="dropdown-menu pull-right" ng-model="selectedopt">
                          <li>
                              <a id="widget3ChartOptions" ng-click="chartPeriodSelector('Daily')" href="#">Daily Report</a>
                          </li>
                          <li>
                              <a id="widget3ChartOptions" ng-click="chartPeriodSelector('Weekly')" href="#">weekly Report</a>
                          </li>
                      </ul>
                    </div> 
                </li>
    ...
    <div class="widget-body">
        <div class="col-lg-12">
            ...
            <div class="graph-choice" id="sales-graph-container">
              <div style="width:100%" id="chart_window"></div>
            </div>
        </div>
    </div>
</div>
