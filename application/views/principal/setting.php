...
<div class="col-sm-10" ng-app="myApp" ng-controller="promote_ctrl">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Are you sure you want to delete this school name?</p>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Are you sure want to delete this element?</p>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Are you sure want to make these dates as active semester dates?</p>
                    ...
                    <div id="collapse1" class="panel-collapse collapse in">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form-inline" name="semesterdetailform" ng-submit="savesessiondates(sessionobj)" novalidate>
                                ...
                                <input type="hidden" name="serial" ng-model="sessionobj.serail">
                                ...
                                <div class="row error-message" ng-hide="sessionlist.length > 0">
                                    ...
                                    <div class="col-sm-12">
                                       ...
                                       <p>
                                            ...
                                            Please first add session before adding new semester dates.
                                ...
                                <div class="row error-message" ng-hide="semesterlist.length > 0">
                                    ...
                                    <div class="col-sm-12">
                                       ...
                                       <p>
                                            ...
                                            Please first add semester before adding new semester dates.
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <table class="table table-bordered table-striped table-hover table-condensed" id="table-body-phase-tow" >
                                            ...
                                            <tbody id="reporttablebody-phase-two" class="report-body">
                                                ...
                                                <tr ng-repeat="s in semester_detail_list">
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <table class="table table-bordered table-striped table-hover table-condensed" id="table-body-phase-tow" >
                                            ...
                                            <tbody id="reporttablebody-phase-two" class="report-body">
                                                ...
                                                <tr ng-repeat="h in holidaytypelist">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-inline" name="assembly" ng-submit="saveassembly(assemblyobj)" novalidate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control getstarttime" autocomplete="off" value="assemblydata.start_time" id="inputStartitme"  name="inputFrom" ng-model="assemblyobj.starttime" placeholder="Start Time" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="InputEndTime" autocomplete="off"  name="inputTo"  ng-model="assemblyobj.endtime"  placeholder="End Time"  tabindex="1" required>
                                    ...
                                    <div class="col-sm-12">
                                       ...
                                       <table datatable="ng" ng-hide="evulationarray.length <= 0" class="table table-striped table-bordered row-border hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr ng-repeat="g in assemblydata">
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="javascript:void(0)" onclick="updateTime();" title="Edit" class="edit" >
                                ...
                                <form class="form-inline breakcontainer" name="break" ng-submit="savebreak(breakobj)" novalidate>
                                   <div class="row" style="margin: 20px 0px"> 
                                        <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control breaktimepicker mon_start_time" autocomplete="off"  name="inputFrom" ng-model="breakobj.monstarttime" placeholder="Start Time" required>
                                                </div>
                                        ...
                                        <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control breaktimepicker mon_end_time" autocomplete="off"  name="inputTo"  ng-model="breakobj.monendtime"  placeholder="End Time"  tabindex="1" required>
                                                </div>
                                                <div class="clearfix"></div>
                                    ...
                                    <div class="row" style="margin: 20px 0px"> 
                                        <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control breaktimepicker tue_start_time" autocomplete="off"  name="inputFrom" ng-model="breakobj.tusstarttime" placeholder="Start Time" required>
                                                </div>
                                                <div class="clearfix"></div>
                                        ...
                                        <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control breaktimepicker tue_end_time"  autocomplete="off" name="inputTo"  ng-model="breakobj.tusendtime"  placeholder="End Time"  tabindex="1" required>
                                                </div>
                                                <div class="clearfix"></div>
                                    ...
                                    <div class="row" style="margin: 20px 0px"> 
                                        <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control breaktimepicker wed_start_time"  autocomplete="off" name="inputFrom" ng-model="breakobj.wedstarttime" placeholder="Start Time" required>
                                                </div>
                                                <div class="clearfix"></div>
                                        ...
                                        <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control breaktimepicker wed_end_time" autocomplete="off" name="inputTo"  ng-model="breakobj.wedendtime"  placeholder="End Time"  tabindex="1" required>
                                                </div>
                                                <div class="clearfix"></div>
                                    ...
                                    <div class="row" style="margin: 20px 0px"> 
                                        <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control breaktimepicker thu_start_time" autocomplete="off" name="inputFrom" ng-model="breakobj.thrstarttime" placeholder="Start Time" required>
                                                </div>
                                                <div class="clearfix"></div>
                                        ...
                                        <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control breaktimepicker thu_end_time"  autocomplete="off" name="inputTo"  ng-model="breakobj.threndtime"  placeholder="End Time"  tabindex="1" required>
                                                </div>
                                                <div class="clearfix"></div>
                                    ...
                                    <div class="row" style="margin: 20px 0px"> 
                                        <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control breaktimepicker fri_start_time" autocomplete="off" name="inputFrom" ng-model="breakobj.fristarttime" placeholder="Start Time" required>
                                                </div>
                                                <div class="clearfix"></div>
                                        ...
                                        <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control breaktimepicker fri_end_time" autocomplete="off" name="inputTo"  ng-model="breakobj.friendtime"  placeholder="End Time"  tabindex="1" required>
                                                </div>
                                                <div class="clearfix"></div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr ng-repeat="b in breakdata">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0)" onclick="getBreakTime();" title="Edit" class="edit" >
       ...
       // when start time change, update minimum for end timepicker
        function tpStartSelect( time, endTimePickerInst ) {
           ...
           $('#InputEndTime').timepicker('option', {
            ...
            {
                $.ajax({
                    'url': "<?php echo base_url()?>getassemblydata",
                    'type': 'POST',
                    'success': function (data) {
                         var string = JSON.parse(data);
                         if (string.length>0) 
                         {
                         $("#inputStartitme").val(string[0]["start_time"]);
                         $("#InputEndTime").val(string[0]["end_time"]);
                         $("#inputStartitme").trigger("change");
                         $("#InputEndTime").trigger("change");
                        }
                    }
                });
            }
        ...
        $('.breaktimepicker').timepicker({
            ...
            function getBreakTime()
            {
                $('.addbreak').show('1000');
                $.ajax({
                    'url': "<?php echo base_url()?>getbreakdata",
                    'type': 'POST',
                    'success': function (data) {
                         ...
                         if (string.length!=0) 
                         {
                         $(".mon_start_time").val(string[0]["monday_start_time"]);
                         $(".mon_end_time").val(string[0]["monday_end_time"]);
                         
                         $(".tue_start_time").val(string[0]["tuesday_start_time"]);
                         $(".tue_end_time").val(string[0]["tuesday_end_time"]);
                         $(".wed_start_time").val(string[0]["wednesday_start_time"]);
                         $(".wed_end_time").val(string[0]["wednesday_end_time"]);
                         $(".thu_start_time").val(string[0]["thursday_start_time"]);
                         $(".thu_end_time").val(string[0]["thursday_end_time"]);
                         $(".fri_start_time").val(string[0]["friday_start_time"]);
                         $(".fri_end_time").val(string[0]["friday_end_time"]);
                         $(".breaktimepicker").trigger("change");
                                        ...
                                        <tr ng-repeat="s in schoolarray">
                                            ...
                                            <td>{{s.cityname}}</td>
                                             ...
                                             <td>
                                                ...
                                                <a href="javascript:void(0)" ng-click="editschool(s.sid)" title="Edit" class="edit">

                                                   <i class="fa fa-edit" aria-hidden="true"></i>

                                                </a>

                                                <a href="javascript:void(0)" ng-click="removeschool(s.sid)" title="Delete"  class="del">
