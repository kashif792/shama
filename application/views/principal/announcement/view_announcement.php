                        ...
                        <div class="form-group">
                            <div class="col-md-6">
                                ...
                                <label><span class="icon-user"></span> Title <span class="required">*</span></label>
                                    ...
                                    <input type="text" class="form-control" name="title" id="title"  ng-model="title" value="<?php echo $annoucement['0']->title ?>">
...
// End here
        ...
        $scope.stopAnnouncementData = function()
        {
            try{
                    ...
                    //console.log(data);
                    httppostrequest('<?php echo $path_url; ?>Principal_controller/stopAnnouncementDetailList',data).then(function(response){
                        $scope.data = [];
                        if(response.length > 0 && response != null)
                        {
                            for (var i=0; i<response[0]['listarray'].length; i++) {
