...
if(ENVIRONMENT == 'production')
{
	...
	define('UPLOAD_PATH', $_SERVER['DOCUMENT_ROOT'].'/invantage/wc/learninginvantage/v1updated/upload/');
}

if(ENVIRONMENT == 'production')
{
	define('IMAGE_LINK_PATH','http://shama.nrschools.net/upload/');
}
else{
	define('IMAGE_LINK_PATH','http://zilonlahore/invantage/wc/learninginvantage/v1updated/upload/');
}
